...
/**
 * Общая основа всех наборов параметров.
 *
 * Открытая запись нужна не для удобства: вертикали принимают ещё и родные
 * параметры поисковиков — tbs и as_sitesearch у Google, isize и iorient у
 * Яндекса, qft и imagesize у Bing. Перечислять их все здесь бессмысленно,
 * они меняются вместе с поисковиками.
 */
