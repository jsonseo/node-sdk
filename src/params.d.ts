import type { AdultFilter, BingSafeSearch, Device, DirectPeriod, Flag, Freshness, GoogleSafeSearch, ImageColor, ImageFormat, ImageOrientation, ImageSize, ImageType, MobileDevice, ParamValue, RegionLanguage, VideoDuration, WordstatGraphType, WordstatKind, WordstatMapType, YandexZone } from './common.js';
/**
