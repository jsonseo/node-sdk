...
/**
 * encodeParams входит в публичный API и решает, в каком виде параметры
 * уедут в сервис. Ошибка здесь — это искажённый запрос за деньги клиента,
 * поэтому проверяется напрямую, а не только через собранный запрос.
 */
